...
call python c:\tools\zulip-api\zulip\zulip\send.py --stream tooling/releases --subject "java IGPublisher" -m "New Java IGPublisher @ https://fhir.github.io/latest-ig-publisher/org.hl7.fhir.publisher.jar (v%newver%). For Maven users: https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=org.hl7.fhir.publisher&a=org.hl7.fhir.publisher.cli&v=%newver%-SNAPSHOT&e=jar" --config-file zuliprc
