  ...
  private String render(String typeName, String mode, List<StructureMap> list) throws IOException, FHIRException, EOperationOutcome {
    ...
    if (list.isEmpty()) {
      ...
      for (StructureMap map : list) {
        ...
        new org.hl7.fhir.r5.renderers.StructureMapRenderer(rc).renderResource(new RenderingStatus(), x, ResourceElement.forResource(rc.getContextUtilities(), rc.getProfileUtilities(), map));
      }
    }
