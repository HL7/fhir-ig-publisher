...
public class QuestionnaireResponseRenderer extends BaseRenderer {
  ...
  public QuestionnaireResponseRenderer(IWorkerContext context, String corePath, Element qr, String destDir, IGKnowledgeProvider igp, List<SpecMapManager> maps, Set<String> allTargets, MarkDownProcessor markdownEngine, NpmPackage packge, RenderingContext gen, ReferenceResolver resolver) {
  ...
  public String render(QuestionnaireRendererMode mode) throws IOException, FHIRFormatError, DefinitionException, FHIRException, EOperationOutcome {
    org.hl7.fhir.services.renderers.QuestionnaireResponseRenderer qr = new org.hl7.fhir.services.renderers.QuestionnaireResponseRenderer(gen);
