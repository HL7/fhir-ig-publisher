...
public class ImposesComparator {
  ...
  public ImposesComparator(SimpleWorkerContext context, String rootDir, String dstDir, ProfileKnowledgeProvider pkp, ILoggingService logger, List<String> versions, RenderingI18nContext i18n) {
    super();
    ...
    if (errMsg == null && pid != null) {
      ...
      for (VersionInstance vi : versionList) {
        ...
        try {
          ...
          //vi.context.initTS();
          vi.context.connectToTSServer(context.getTxClientManager().getFactory(), context.getTxClientManager().getMasterClient(), true);
